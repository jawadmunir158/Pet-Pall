                ...
                <div className="grid grid-cols-3 gap-4 mb-6 pl-48">
                    <div className="col-span-2">
                        ...
                        <div className="flex items-center justify-center py-4">
                            <img
                                src="https://media-mct1-1.cdn.whatsapp.net/v/t61.24694-24/472011552_486121977449881_6334751090301795523_n.jpg?ccb=11-4&oh=01_Q5AaID3tiALxejiSs25y6nvW3GV5AKEydFk6usGkUWQr0QHj&oe=678E45E6&_nc_sid=5e03e0&_nc_cat=103"
                                alt="Dr. Maha Ijaz"
                                className="w-32 h-32 rounded-full object-cover border-2 border-teal-700"
                            />
                        </div>
                        <h2 className="text-teal-700 font-bold text-center">Dr. Maha Ijaz</h2>
