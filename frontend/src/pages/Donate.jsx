...
const Donate = () => {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="p-6 rounded-lg w-full max-w-4xl"> {/* Removed bg-white */}
        ...
        <img
          ...
          className="w-2/4 rounded-lg mb-4 mx-auto transition-transform transform hover:scale-105 hover:shadow-lg" 
          height="300"
        ...
        <div className="flex justify-center space-x-4 pt-6"> 
          <div className="flex flex-col items-center">
            <img
              ...
              className="w-2/4 rounded-lg mb-2 transition-transform transform hover:scale-105 hover:shadow-lg"
              height="200"
